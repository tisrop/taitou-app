...
class FindInteractionController {
 public:
  ...
  std::unique_ptr<FindInteractionChannelDelegate> channelDelegate_ = nullptr;
  std::optional<std::string> searchText_ = std::nullopt;
  std::optional<FindSession> activeFindSession_ = std::nullopt;
